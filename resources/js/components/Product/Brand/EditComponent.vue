                        ...
                        <div class="card-body text-center pt-0">
                            ...
                            <div class="image-input image-input-empty image-input-outline mb-3"
                                ...
                                <div class="image-input-wrapper w-150px h-150px">
                                    <img id="oldImage" v-if="brand.image" :src="'/storage/'+brand.image" alt="" class="symbol symbol-50px" width="80px" height="80px" />
                                </div>
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" v-model="brand.name" name="name" class="form-control mb-2" placeholder="Category name"
                                    value="" />
...
export default {
    ...
    methods:{
        ...
        removeImage () {
            this.brand.image = ''
            document.getElementById('oldImage').style.display = "inline";
        },
        ...
        Update () {
            ...
            axios.post('/api/admin/brand/update/'+this.brand.id , data)
            .then(()=>{
                console.log('done');
