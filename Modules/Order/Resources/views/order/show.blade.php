...
@section('nav_title','Order Details')
...
@section('breadcrumb')
	<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
                                        ...
                                        <!--begin::Item-->
										<li class="breadcrumb-item text-muted">
											<a href="{{route('admin.orders.index')}}" class="text-muted text-hover-primary">Orders</a>
										</li>
										<!--end::Item-->
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="d-flex flex-column gap-7 gap-lg-10">
                <div class="d-flex flex-wrap flex-stack gap-5 gap-lg-10">
                    ...
                    <!--end:::Tabs-->
                    <!--begin::Button-->
                    <a href="../../demo8/dist/apps/ecommerce/sales/listing.html" class="btn btn-icon btn-light-primary btn-sm ms-auto me-lg-n7">
                    ...
                    <!--end::Button-->
                    <!--begin::Button-->
                    <a href="../../demo8/dist/apps/ecommerce/sales/add-order.html" class="btn btn-light-primary btn-sm">Add New Order</a>
                    <!--end::Button-->
                </div>
                <!--begin::Order summary-->
                                ...
                                <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        ...
                                        <tr>
                                            ...
                                            <td class="fw-bolder text-end">
                                                <div class="d-flex align-items-center justify-content-end">
                                                    ...
                                                    <!--end::Avatar-->
                                                    <!--begin::Name-->
                                                    <a href="../../demo8/dist/apps/ecommerce/customers/details.html" class="text-gray-600 text-hover-primary">{{$order->user->name}}</a>
                                                    <!--end::Name-->
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="fw-bolder text-end">
                                                <a href="../../demo8/dist/apps/user-management/users/view.html" class="text-gray-600 text-hover-primary">{{$order->user->email}}</a>
                                            </td>
                                        </tr>
                                        <!--end::Payment method-->
                                        <!--begin::Date-->
                                ...
                                <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        ...
                                        <tr>
                                            ...
                                            <td class="fw-bolder text-end">
                                                <a href="../../demo8/dist/apps/invoices/view/invoice-3.html" class="text-gray-600 text-hover-primary">#INV-000414</a>
                                            </td>
                                        </tr>
                                        <!--end::Invoice-->
                                        <!--begin::Shipping-->
                                ...
                                <div class="card-body pt-0">
                                    <div class="table-responsive">
                                        ...
                                        <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                            ...
                                            <tbody class="fw-bold text-gray-600">
                                                <!--begin::Products-->
                                                  @foreach ($order->ordersdetails as $orderdetail)
                                                  <tr>
                                                    <!--begin::Product-->
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <a href="../../demo8/dist/apps/ecommerce/catalog/edit-product.html" class="symbol symbol-50px">
                                                                <span class="symbol-label" style="background-image:url({{asset('assets/Admin/media//stock/ecommerce/100.gif')}});"></span>
                                                            </a>
                                                            <!--end::Thumbnail-->
                                                            <!--begin::Title-->
                                                            <div class="ms-5">
                                                                <a href="../../demo8/dist/apps/ecommerce/catalog/edit-product.html" class="fw-bolder text-gray-600 text-hover-primary">{{$orderdetail->product->name}}</a>
                                                                <div class="fs-7 text-muted">Delivery Date: {{$orderdetail->created_at}}</div>
                                                            </div>
                                                            <!--end::Title-->
                                                        </div>
                                                    </td>
                                                    <!--end::Product-->
                                                    <!--begin::SKU-->
                                                    <td class="text-end">{{$orderdetail->product->sku}}</td>
                                                    <!--end::SKU-->
                                                    <!--begin::Quantity-->
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-dark fs-3 fw-boldest text-end">${{$order->ordersdetails->sum('total')}}</td>
                                                </tr>
                                                <!--end::Grand total-->
                                            </tbody>
                                            <!--end::Table head-->
